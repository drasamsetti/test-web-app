...
$query="select count(id) as count from theme_master";
$result=mysql_query($query) or die("could not execute query");
$row=mysql_fetch_array($result);

$xml="<chart bgColor='FFFFFF' gaugeStartAngle='225' gaugeEndAngle='-45' bgAlpha='100' lowerLimit='0' upperLimit='50' majorTMNumber='8' majorTMThickness='3' majorTMColor='FFFFFF' majorTMHeight='7' minorTMNumber='0' placeValuesInside='1' sgaugeOriginY='160' gaugeOuterRadius='110' gaugeInnerRadius='100' showShadow='0' pivotRadius='20' pivotFillColor='000000,383836'   pivotFillType='linear' pivotFillRatio='50,50' pivotFillAngle='240' annRenderDelay='0' gaugeFillMix='' showPivotBorder='1' pivotBorderColor='999999' pivotBorderThickness='2'>
	<dials>
		<dial value='".$row['count']."' color='FFFFFF,999999' alpha='100' showBorder='0' baseWidth='3' topWidth='3' radius='100' />
	</dials>
